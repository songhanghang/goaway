    ...
    private class AwayEngine extends Engine {
        ...
        private void doDraw() {
            ...
            try {
                ...
                String content = String.format("%s %s | %s", useStr, timeStr, tips);
